...
// Watchers
watch(() => props.projectStructure, (newStructure) => {
					...
					<div v-for="item in filteredProjectStructure" :key="item.path">
						<div class="tree-item">
							...
							>
								...
								<span v-if="getCommentForPath(item.path)" class="comment-indicator"
									>💬</span
								>
							</div>
			...
			<div class="comment-panel">
				...
				<div v-else class="no-selection">
					<div class="no-selection-content">
						...
						<p>
							Choose an item from the project structure to add comments and feedback
						</p>
					</div>
				</div>
			</div>
